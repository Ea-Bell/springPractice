...
//	private String extraAddress;
	...
	private String coYn;  //이거 없음
	private String foreignYn; //이거 없음
	private String taxYn;
	private String country_eng;
	private String country_kor;
	private String specialRelation; //이거 없음
	private String tradeStop; //이거 없음
	private String contractPeriodS;
	private String contractPeriodE;
	private String regiInfoMan;//이거 없음
	private String regiInfoDate; //이거 없음
	private String modiInfoMan; //이거 없음
	private String modiInfoDate; // 이거 없음
	
	
	public Page2Dto(){}
	
	public Page2Dto(String busiNum, String factory, String tradeBank, String accountNum, String custom,
			String customShort, String ceo, String chargePerson, String busiCondition, String item, String postNum,
			String addr1, String addr2, String tel, String fax, String homepage, String coYn, String foreignYn,
			String taxYn, String country_eng, String country_kor, String specialRelation, String tradeStop,
			String contractPeriodS, String contractPeriodE, String regiInfoMan, String regiInfoDate, String modiInfoMan,
			String modiInfoDate) {
		super();
	...
	public String toString() {
		return "Page2Dto [busiNum=" + busiNum + ", factory=" + factory + ", tradeBank=" + tradeBank + ", accountNum="
				+ accountNum + ", custom=" + custom + ", customShort=" + customShort + ", ceo=" + ceo
