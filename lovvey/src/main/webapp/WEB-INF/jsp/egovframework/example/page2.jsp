...
<form id="page2Form">
	...
	<P> 사업자 번호 <input type="text" id="busiNum" name="busiNum" value="${page2.busiNum}">  약 칭 <input type="text" id="customShort" name="customShort" >  </P>
	...
	<p>특수관계자<input type="checkbox" id="specialRelation" name="specialRelation" value="t"> 거래중지<input type="checkbox" id="tradeStop" name="tradeStop" value="t">
	<input type="hidden" id="specialRelation" name="specialRelation" value="f"><input type="hidden" id="tradeStop" name="tradeStop" value="f">
	...
	<button ></button>
	<button type="submit" formaction="/lovvey/page2/save" formmethod="post" onclick="sucessAlert()">전송</button>
	<button formaction="/lovvey/page2/" formmethod="get">삭제</button> <%-- 그자리에서 경고 알림 후 삭제 요청하기. --%>
	</form>
